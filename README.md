...
├── diensten.html                 Overzicht diensten (matras, meubel, vloer)
├── particulier.html              Pagina voor particuliere klanten
├── zakelijk.html                 Pagina voor zakelijke klanten
├── contact.html                  Contactpagina met formulier
├── professionele-reiniging.html  SEO-landingspagina met FAQ
├── bedankt.html                  Bedankpagina na formulierverzending
├── 404.html                      Foutpagina (pagina niet gevonden)
├── contact.php                   PHP-handler voor contactformulier
├── css/
│   └── style.css                 Alle styling
├── js/
│   └── main.js                   Alle JavaScript
├── .gitignore
└── README.md
```
